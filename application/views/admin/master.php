        ...
        <div class="wrapper">
            <header class="main-header">
                <a href="<?php echo base_url(); ?>admin" class="logo">
                    <span class="logo-mini"><b>KBR</b></span>
                    <span class="logo-lg"><b>KBR Companies</b></span>
                </a>
            ...
            <aside class="main-sidebar">
                <section class="sidebar">
                    <ul class="sidebar-menu">
                        ...
                        <li class="treeview">
                            <a href="#">
                                <i class="fa fa-envelope"></i> <span>Message Manager</span>
                                <i class="fa fa-angle-left pull-right"></i>
                            </a>
                            <ul class="treeview-menu">
                        ...
                        <li class="treeview">
                            <a href="#">
                                <i class="fa fa-tasks"></i> <span>Project Management</span>
                                <i class="fa fa-angle-left pull-right"></i>
                            </a>
                            <ul class="treeview-menu">
            ...
            <footer class="main-footer">
                <strong>Copyright © <a href="<?php echo base_url(); ?>">KBR Companies</a></strong> All Rights Reserved.
            </footer>
            <script>
